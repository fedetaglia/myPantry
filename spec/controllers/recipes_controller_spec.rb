...
describe RecipesController do
  ...
  let(:unvalid_attributes) { attributes_for(:recipe).merge('yummly_id'=>nil)}
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved recipe as @recipe" do
        ...
        post :create, {:recipe => unvalid_attributes}
        assigns(:recipe).should be_a_new(Recipe)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested recipe" do
        ...
        Recipe.any_instance.should_receive(:update).with(valid_attributes.stringify_keys)
    ...
    describe "with invalid params" do
      it "assigns the recipe as @recipe" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Recipe.any_instance.stub(:save).and_return(false)
        put :update, {:id => recipe.to_param, :recipe => unvalid_attributes}
        assigns(:recipe).should eq(recipe)
      end
